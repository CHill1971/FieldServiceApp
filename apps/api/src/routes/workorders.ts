...
// Update status
workordersRouter.put('/:id/status', async (req: Request, res: Response) => {
...
// Check-in
workordersRouter.post('/:id/checkin', async (req: Request, res: Response) => {
  const now = new Date();
...
// Check-out
workordersRouter.post('/:id/checkout', async (req: Request, res: Response) => {
  const now = new Date();
  const gps = req.body?.gps ?? null;
  const workOrderId = req.params.id;
  const techId = req.user!.id;
...
// Add item line
workordersRouter.post('/:id/items', async (req: Request, res: Response) => {
...
workordersRouter.post('/:id/photos', async (req: Request, res: Response) => {
...
workordersRouter.post('/:id/signature', async (req: Request, res: Response) => {
